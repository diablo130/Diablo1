...
<%
    //application.setAttribute("login","no");
...
<script>
  ...
  <body>
    <h1>THis is my FirstPage</h1
        <h2>adSXXZCZFDDASDADADADASDFdfaf</h2>
    ...
    <p id="info"><%="Welcome," + session.getAttribute("myname")%>&nbsp;&nbsp;&nbsp;<a href="#" onclick="status()" >Logout</a></p>
    <% } else {%>
    ...
    <p><%="用JSP测试输出"+ application.getAttribute("diablo130") %></p>
    ...
    <hr />
    <h1>现在时间是：<%=(new java.util.Date()).toLocaleString()%></h1>           <%--表达式--%>
